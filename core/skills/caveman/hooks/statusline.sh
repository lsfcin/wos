...
#   "statusLine": { "type": "command", "command": "bash /path/to/core/skills/caveman/hooks/statusline.sh" }
#
...
# Reads a pre-rendered string written by stats.js so we don't shell out
